...
class User {
  ...
  function add() {
    $sql = "INSERT INTO user (user_id, emp_id, email, f_name, l_name, m_name, acad_rank, user_role, password) VALUES
    (:user_id, :emp_id, :email, :f_name, :l_name, :m_name, :acad_rank, :user_role, :password);";
    ...
    $query->bindParam(':acad_rank', $this->acad_rank);
