                    ...
                    <div class="input_width d-flex" style="width: 40% !important;">
                        <form id="searchForm" method="GET" action="" style="width: 100% !important;">
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary brand-bg-color" type="submit"><i class='bx bx-search' aria-hidden="true"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    ?>
                        ...
                        <div class="col-12 mb-5">
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3">
                                <?php foreach ($departmentDataArray as $department):
                                    // Separate department_id and department_name
                                    list($departmentId, $departmentName) = explode(':', $department);
                                ?>
                                    <div class="col">
